...
class JobSeekerProfileForm(forms.ModelForm):
    """Form to collect job seeker profile data for CV generation."""
    ...
    class Meta:
        ...
        widgets = {
            ...
            'skills': forms.Textarea(attrs={'class': 'form-control', 'rows': 3, 'placeholder': 'Skills, separated by commas or lines'}),
            'work_experience': forms.Textarea(attrs={'class': 'form-control', 'rows': 4, 'placeholder': 'Work experience details, one entry per line'}),
